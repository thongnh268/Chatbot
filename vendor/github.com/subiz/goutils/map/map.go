...
type UpsertCb func(exist bool, valueInMap, newval interface{}) interface{}
...
func (m Map) GetOrInit(key string, ctor func() interface{}) (interface{}, bool) {
	// Get shard
	shard := m.GetShard(key)
	shard.RLock()
	// Get item from shard.
